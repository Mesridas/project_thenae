    ...
    class CarouselsModel extends CoreModel {
        ...
        public function readVisible(){
            ...
            try{
                ...
                $query = 'SELECT `car_id` AS `id`, `car_title_carousel` AS `title_carousel`, `car_title` AS `title`, `car_location` AS `location`, `car_type_img` AS `type_img`, `car_image` AS `image` FROM `CAROUSEL` WHERE `car_type_img` = 1  ORDER BY `car_id` LIMIT 12 ';
