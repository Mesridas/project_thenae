    ...
    class SectionsModel extends Coremodel {
        ...
        public function update($id, $request){
            ...
            try {
                ...
                $query = 'UPDATE `SECTION` SET `sec_image` = :image, `sec_text` = :txt, `sec_title` = :title WHERE `sec_id` = :id ';     
              
                if(($req = $this->getDb()->prepare($query))!==false) {
         
                 if($req->bindValue('id', $id, PDO::PARAM_INT) && $req->bindValue('image', $request['mon_image']) && $req->bindValue('txt', $request['desc']) && 
        ...
        public function delete($id){
            ...
            try{
              ...
              $query = 'DELETE FROM `SECTIONS` WHERE `sec_id` = :id ';
